...
function printUpdateCarabelliParametersFunction(minSamplingPeriod, maxSamplingPeriod, samplingPeriodStepSize)
	header = """
...
println(IO)
printUpdateCarabelliParametersFunction(minSamplingPeriod, maxSamplingPeriod, samplingPeriodStepSize)
println(IO)
